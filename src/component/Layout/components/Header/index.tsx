      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between lg:justify-evenly">
          ...
          <div className="hidden gap-2 lg:flex">
            <button type="button" className="h-10 w-20 rounded-md font-medium text-[#4CAF4F]">
              login
            </button>
            <button
              type="button"
              className="h-10 w-24 rounded-md bg-[#4CAF4F] font-medium text-white"
            >
              Signup
            </button>
          </div>
          ...
          <div className="lg:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3 sm:px-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button type="button" className="h-10 w-full rounded-md font-medium text-[#4CAF4F]">
                  login
                </button>
                <button
                  type="button"
                  className="h-10 w-full rounded-md bg-[#4CAF4F] font-medium text-white"
                >
                  Signup
                </button>
              </div>
