  ...
  return (
    <div className="mx-1 my-3 flex w-full flex-col space-y-2">
      ...
      <select
        ...
        className={`block w-full rounded-md border bg-white px-3 py-2 text-sm text-gray-900 shadow-sm ${error ? 'border-red-500' : 'border-gray-300'} ${disabled ? 'cursor-not-allowed bg-gray-100 text-gray-400' : 'hover:border-gray-400'} ${className}`}
      >
