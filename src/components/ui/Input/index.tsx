...
import { Input as InputCn } from '@src/components/shadcn/ui/input';
import TextArea from '@src/components/ui/Input/TextArea';
import Dropdown from '@src/components/ui/Input/Dropdown';
...
export default withProperties(Input, { TextArea, Dropdown });
